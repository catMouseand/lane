...
def main():
    ...
    optimizer = fluid.optimizer.AdamOptimizer(learning_rate=base_lr)#用了adam优化器
    ...
    exe.run(fluid.default_startup_program())#此处run用的是静态图
    ...
    # exec_strategy = fluid.ExecutionStrategy()#多线程使用GPU
