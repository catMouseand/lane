...
######
image_dir = 'F:/2Master_Thesis/lane detection/Image_Data/'
label_dir = 'F:/2Master_Thesis/lane detection/Gray_Label/Gray_Label/'

for s1 in os.listdir(image_dir):
    image_sub_dir1 = os.path.join(image_dir, s1)
    label_sub_dir1 = os.path.join(label_dir, 'Label_' + str.lower(s1), 'Label')#str.lower把大写字母转化成小写字母
